...
export const styles = {
  ...
  profileMenuSandboxAvatar: {
    background: "linear-gradient(135deg, #2563EB, #1D4ED8)",
    boxShadow: "0 8px 18px rgba(37,99,235,0.24)",
  } satisfies CSSProperties,
  profileMenuIdentityText: {
    minWidth: 0,
    flex: 1,
  } satisfies CSSProperties,
  profileMenuIdentityName: {
    display: "block",
    overflow: "hidden",
    textOverflow: "ellipsis",
    whiteSpace: "nowrap",
  ...
  profilePanelSandboxBadge: {
    ...
    background: "#2563EB",
    color: "#FFFFFF",
    boxShadow: "0 6px 12px rgba(37,99,235,0.24)",
  } satisfies CSSProperties,
