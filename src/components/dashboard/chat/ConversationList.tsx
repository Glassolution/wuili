      ...
      <div className="border-b border-[#EBEBEB] dark:border-zinc-800 px-4 pb-3 pt-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-[#EBEBEB] dark:border-zinc-700 bg-[#F7F7F7] dark:bg-zinc-800 py-2 pl-8 pr-3 text-[13px] text-[#0A0A0A] dark:text-white placeholder:text-[#A3A3A3] dark:placeholder:text-zinc-500 focus:border-[#D4D4D4] dark:focus:border-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#0A0A0A]/8 dark:focus:ring-white/10 transition"
          />
        </div>
      </div>
            ...
            <button
              ...
              className={`flex w-full items-center gap-3 px-4 py-3 text-left transition-colors ${
                isActive
                  ...
                  : 'hover:bg-[#FAFAFA] dark:hover:bg-zinc-800/70'
              }`}
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="truncate text-[11.5px] text-[#737373] dark:text-zinc-400">
                  {conv.productName}
                </p>
                <div className="mt-0.5 flex items-center justify-between gap-1">
                  <p className={`truncate text-[12px] ${conv.unread > 0 ? 'font-medium text-[#0A0A0A] dark:text-white' : 'text-[#A3A3A3] dark:text-zinc-500'}`}>
