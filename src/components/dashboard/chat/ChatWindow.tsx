      ...
      <div className="flex items-center gap-3 border-b border-[#EBEBEB] dark:border-zinc-800 px-4 py-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2">
            <Package size={11} className="shrink-0 text-[#A3A3A3] dark:text-zinc-500" />
            <span className="truncate text-[11.5px] text-[#737373] dark:text-zinc-400">{conversation.productName}</span>
        ...
        {/* Options */}
        <button className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-[#A3A3A3] dark:text-zinc-500 transition hover:bg-[#F5F5F5] dark:hover:bg-zinc-800 hover:text-[#525252] dark:hover:text-zinc-300">
        ...
        <div className="space-y-3">
          ...
          {conversation.status === 'typing' && (
            <div className="flex items-end gap-2.5">
              ...
              <div className="rounded-2xl rounded-bl-sm bg-[#F0F0F0] dark:bg-zinc-800 px-4 py-3">
