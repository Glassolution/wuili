...
const FeaturesSection = () => (
  <section id="funcionalidades" className="relative z-[1] bg-[#0a0a0a] py-[120px]">
    <div className="mx-auto max-w-[1100px] px-6 md:px-10">
      ...
      <div className="grid grid-cols-1 gap-px overflow-hidden rounded-[20px] bg-white/[0.06] sm:grid-cols-2 lg:grid-cols-3">
        {features.map((f) => (
          <div key={f.title} className="bg-[#0a0a0a] p-8 transition-colors hover:bg-white/[0.03] md:p-9">
            <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-white/[0.07]">
              <f.icon size={20} className="text-[#8ec5ff]" />
            </div>
            <div className="mb-[10px] font-['Sora'] text-base font-semibold tracking-[-0.025em] text-white">{f.title}</div>
