...
import { AlignCenter, AlignLeft, AlignRight, ArrowRight, Check, ChevronDown, ChevronLeft, ChevronRight, Circle, Command, Copy, Download, Eye, ExternalLink, Facebook, FileUp, FolderPlus, Gem, Gift, Globe, Hand, Headphones, Heart, HelpCircle, Home, ImageIcon, Instagram, Layers3, LayoutGrid, Leaf, Link2, List, Loader2, LockKeyhole, Menu, MessageSquare, Minus, Monitor, MousePointer2, Package, Palette, Pencil, Plus, Quote, RectangleHorizontal, Redo2, RefreshCcw, Save, Search, Settings, Share2, ShoppingBag, Smartphone, Sparkles, Square, Star, Tag, Trash2, Truck, Twitter, Type, Undo2, UserRound, X, Youtube, type LucideIcon } from "lucide-react";
...
import {
  ...
  type CatalogItem,
  type EditorPanelTab,
  type EditorPanelSection,
  type ContextDrawerMode,
  type EditMode,
  type ToolbarTool,
  type CanvasToolbarMode,
  type EditorElementType,
  type EditableDomElement,
  type ImageShape,
  type TextWeight,
  type ButtonToolbarPanel,
  ...
  formatBRL,
  PUBLIC_APP_URL,
  fetchEditorCollectionProducts,
  catalogTaxonomy,
  defaultContextControls,
  iconPickerOptions,
  renderIconMarkup,
  hslToHex,
  colorToHex,
  ...
  buttonStylePresets,
  buttonSizePresets,
} from "@/pages/GeneratedStoreEditorPage.helpers";
