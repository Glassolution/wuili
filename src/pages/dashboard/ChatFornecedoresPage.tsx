...
export default function ChatFornecedoresPage() {
  ...
  return (
    <div
      className="flex overflow-hidden rounded-2xl border border-[#E5E5E5] bg-white shadow-sm"
...
function EmptyState() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-4 bg-[#FAFAFA] text-center">
      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-[#E5E5E5] bg-white shadow-sm">
        <MessageSquare size={22} className="text-[#A3A3A3]" />
      </div>
      <div>
