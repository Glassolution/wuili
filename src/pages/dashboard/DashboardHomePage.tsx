  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1160px] px-4 lg:px-6 pt-4">
        ...
        {/* ── Welcome + Search ───────────────────────────────────────────── */}
        <section className="mt-[14vh] flex flex-col items-center text-center">
          {/*
            Tipografia editorial: "Velo" em Playfair Display itálico,
            restante em Plus Jakarta Sans. Aplicado APENAS neste título.
          */}
          ...
          {/* Campo de busca / Atlas */}
          <form
            onSubmit={(e) => {
              e.preventDefault();
              handleSearchSubmit(inputText);
            }}
            className="mt-6 w-full max-w-[760px] flex items-center gap-2 bg-white border border-neutral-200 rounded-full pl-4 pr-2 py-2 shadow-[0_2px_10px_rgba(0,0,0,0.03)] focus-within:border-neutral-400 transition-colors"
          >
            <AtlasAvatar size={24} />
            <input
              type="text"
