    ...
    <>
      <div className="mx-auto max-w-[680px] px-6 py-10">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-[13px] text-[#737373]">
            Gere um prompt otimizado para criar o vídeo no RunwayML
          </p>
        </div>
        ...
        {mostrarResultado && (
          ...
          >
            <div className="space-y-0.5 pb-1">
              ...
              <p className="text-[12px] text-[#737373]">Copie e use no RunwayML</p>
            </div>
            ...
            <div
              ...
              onClick={() => {
                navigator.clipboard.writeText(promptGerado);
                toast.success("Prompt copiado! Abrindo RunwayML...");
                window.open("https://runwayml.com", "_blank", "noopener");
              }}
            >
