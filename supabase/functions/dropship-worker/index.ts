...
const ORDER_FIELDS = [
  ...
  "c7drop_pix_copy_paste",
  "c7drop_pix_key",
  "c7drop_pix_generated_at",
  "c7drop_pix_expires_at",
  "c7drop_pix_renewal_count",
  "frete_real",
  "preco_produto",
  "reservado_at",
...
const UpdateSchema = z.object({
  ...
  patch: z.object({
    ...
    // Pix gerado pelo bot dentro do checkout da C7Drop (45 min, ate 3 renovacoes).
    c7drop_pix_copy_paste: z.string().max(4000).nullable().optional(),
    c7drop_pix_key: z.string().max(500).nullable().optional(),
    c7drop_pix_generated_at: z.string().datetime().nullable().optional(),
    c7drop_pix_expires_at: z.string().datetime().nullable().optional(),
    c7drop_pix_renewal_count: z.number().int().min(0).max(10).optional(),
    ...
    pagamento_confirmado_at: z.string().datetime().nullable().optional(),
