import{e as i,r as xt,j as e}from"./vendor-react-DNIqRoEp.js";import{b as Xe,c as mt,u as gt}from"./vendor-query-DEHbxmQ5.js";import{S as xe}from"./skeleton-taIWD-PB.js";import{aV as ut,aQ as u}from"./vendor-CecNt-VD.js";import{u as Ze,s as M,c as me,a as ft}from"./index-Dl1cTBFs.js";import{U as et}from"./UpgradeLimitModal-jOG1J8Pu.js";import{u as qe}from"./usePlanLimits-XcOWlUoa.js";import{u as ht}from"./useStartMode-CoQZ3He_.js";import{g as bt,b as yt,i as jt}from"./FirstStoreOnboarding-COBESsJH.js";import{b2 as Be,r as ae,ad as Ee,X as vt,aO as Nt,aM as wt,au as kt,P as At,f as tt,an as _t,aS as zt,aT as Ct,K as St,aU as Pt,ao as ze,aN as at,aA as Mt,aE as It,aK as Lt,s as $e,aC as Dt,t as Oe,u as Ue,$ as Tt}from"./vendor-icons-CSFlYoAW.js";import{P as Et}from"./PlatformLogo-CPhEvGVK.js";import{R as $t,P as Rt,b as st,a as Ft,h as ot,O as rt,d as it}from"./vendor-radix-DwPvr873.js";import"./vendor-supabase-DvHmBoHV.js";import"./usePlan-BwpYETsT.js";const T=60,O="#0A0A0A",H=a=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(a),qt=a=>{try{const r=typeof a=="string"?JSON.parse(a):a;return Array.isArray(r)&&r.length>0?r[0]:null}catch{return null}},Bt=a=>{try{const r=typeof a=="string"?JSON.parse(a):a,t=Array.isArray(r)?r[0]:(r==null?void 0:r[0])??r;return(t==null?void 0:t.vid)??(t==null?void 0:t.variantId)??(t==null?void 0:t.variant_id)??(t==null?void 0:t.id)??(t==null?void 0:t.skuId)??(t==null?void 0:t.sku_id)??null}catch{return null}},Ot=a=>a?`https://www.cjdropshipping.com/product-detail.html?id=${encodeURIComponent(a)}`:null,Ve=[{num:1,label:"Detalhes"},{num:2,label:"Revisão"}],Ut=({open:a,onClose:r,product:t})=>{const{user:n}=Ze(),h=ut(),k=qe(),{isStartMode:N}=ht(),[m,c]=i.useState(1),[j,w]=i.useState(""),[b,_]=i.useState(0),[S,A]=i.useState(!1),[z,d]=i.useState(null),[I,L]=i.useState(!1),[U,se]=i.useState(null),[oe,ge]=i.useState(!1),[Q,ue]=i.useState(2.5),[E,V]=i.useState(""),[K,re]=i.useState(!1),[X,fe]=i.useState(!1),[Ce,Z]=i.useState(!1),[ie,ne]=i.useState(!1),[W,Se]=i.useState({ml:!0,shopee:!1,tiktok:!1});i.useEffect(()=>{!n||!a||(async()=>{const{data:o}=await M.from("user_integrations").select("access_token").eq("user_id",n.id).eq("platform","mercadolivre").maybeSingle();d(!!(o!=null&&o.access_token))})()},[n,a]),i.useEffect(()=>{a?requestAnimationFrame(()=>A(!0)):A(!1)},[a]);const[Pe,q]=i.useState(null);if(t&&t.id!==Pe){q(t.id);const o=t.title.length>T?t.title.substring(0,T):t.title;w(o),ue(2.5),_(Math.round(t.cost_price*2.5*100)/100),c(1),se(null),L(!1),V(""),ne(!1)}const G=(t==null?void 0:t.cost_price)??0,$=G,he=o=>{_(Math.round(G*o*100)/100)},P=i.useMemo(()=>Math.round((b-$)*100)/100,[b,$]),J=i.useMemo(()=>b>0?Math.round((b-$)/b*100):0,[b,$]),ee=t?qt(t.images):null,D=(t==null?void 0:t.stock_quantity)??0,le=D>0;i.useEffect(()=>{if(!a||!(t!=null&&t.description))return;let o=!1;return(async()=>{var g,x,p;Z(!0);try{const{data:y,error:l}=await M.functions.invoke("chat",{body:{messages:[{role:"user",content:`Você é um tradutor especialista em e-commerce brasileiro. Traduza a descrição deste produto para português do Brasil, mantendo o sentido original e adaptando termos naturais de venda. Não invente características novas. Responda APENAS com a descrição traduzida, sem introdução, sem comentários.
